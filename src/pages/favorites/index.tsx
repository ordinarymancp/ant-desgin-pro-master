            ...
            buttonGroup.map((item, index) => {
              ...
              if (groupIndex >= startIndex && groupIndex < endIndex) {
                ...
                if (!searchResult || buttonGroup[index].name.indexOf(searchResult) !== -1) {
                  ...
                  // @ts-ignore
                  // eslint-disable-next-line max-len
                  return <Cards content={buttonGroup[index].name} ischildrenCard={true}  opacityTime={parseInt(index)*100} state={buttonGroup[index].state} handleClick={this.routerButtonClick.bind(this, buttonGroup[index].url)} src={buttonGroup[index].image}/>
                } return null
              } return null
            })
          }
